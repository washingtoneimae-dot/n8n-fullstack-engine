...
const ROUTES_FILE = process.env.ROUTES_FILE || path_1.default.join(process.cwd(), 'routes.json');
const PUBLIC_DIR = process.env.PUBLIC_DIR || path_1.default.join(process.cwd(), 'public');
...
function loadRoutes() {
    try {
        const data = fs_1.default.readFileSync(ROUTES_FILE, 'utf-8');
...
function matchRouteConfig(routes, reqPath, method) {
